...
export default function ContentSection() {
  return (
    <section className="space-y-8 pt-8 border-t border-border" aria-label="Guide to image compression">
      ...
      <div className="space-y-3">
        ...
        <p className="text-text-muted text-sm leading-relaxed">
          There are two main types of image compression: <strong className="text-text-main">lossy</strong> and <strong className="text-text-main">lossless</strong>. Lossy compression (used for JPG and WebP) permanently removes some image data to achieve smaller file sizes — typically reducing files by 60–90% with minimal visible quality loss. Lossless compression (used for PNG) reduces file size without losing any data, but typically achieves smaller reductions of 10–30%.
        </p>
      </div>

      <div className="space-y-3">
        <h2 className="text-xl font-bold text-text-main">How to Compress Images Online — 3 Simple Steps</h2>
        <ol className="space-y-4">
          <li className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-text-muted leading-relaxed">Click the upload area above, drag and drop your image, or paste it from your clipboard (Ctrl+V). We accept JPG, PNG, and WebP files up to 20MB.</p>
            </div>
          </li>
          <li className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-text-muted leading-relaxed">Use the quality slider to balance file size against image quality. The default setting of 80% delivers excellent results for most images — reducing file size by 60–80% while keeping the image looking sharp. Set it lower (40–60%) for maximum compression, or higher (85–95%) to preserve fine details in photos.</p>
            </div>
          </li>
          <li className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-text-muted leading-relaxed">Compression happens instantly in your browser. Once complete, you will see the original size, compressed size, and how much space you saved. Click the Download button to save your compressed image.</p>
            </div>
          </li>
        </ol>
      </div>
      ...
      <div className="space-y-3">
        ...
        <ul className="space-y-2 text-sm text-text-muted">
          <li className="flex gap-2">
            ...
            <span><strong className="text-text-main">Faster websites:</strong> Images are the single largest contributor to page weight. Compressing images can cut load times by 2–5 seconds on mobile connections, directly improving Google Core Web Vitals scores and SEO rankings.</span>
          </li>
          <li className="flex gap-2">
            <span className="text-primary font-bold mt-0.5">→</span>
            <span><strong className="text-text-main">Lower storage costs:</strong> Compressed images take up less space in cloud storage (AWS S3, Google Cloud, Cloudinary), which reduces hosting costs at scale. A website with 10,000 product images can save gigabytes of storage by compressing to optimal sizes.</span>
          </li>
          <li className="flex gap-2">
            <span className="text-primary font-bold mt-0.5">→</span>
            <span><strong className="text-text-main">Email and social media sharing:</strong> Many email services reject attachments over 10MB, and social platforms automatically re-compress images (often poorly). Compressing before uploading gives you control over final quality.</span>
          </li>
          <li className="flex gap-2">
            <span className="text-primary font-bold mt-0.5">→</span>
            <span><strong className="text-text-main">Better mobile experience:</strong> Mobile users on 4G or slower connections benefit the most from optimized images. Reducing image sizes by 70% can save megabytes of data per page load.</span>
          </li>
          <li className="flex gap-2">
            <span className="text-primary font-bold mt-0.5">→</span>
            <span><strong className="text-text-main">E-commerce conversions:</strong> Studies show that a 1-second delay in page load time reduces conversions by up to 7%. Optimizing product images is one of the fastest ways to improve site speed and revenue.</span>
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="rounded-xl border border-border p-4 space-y-1">
            ...
            <p className="text-xs text-text-muted leading-relaxed">Best for photographs and images with gradients. Lossy compression achieves 60–90% file size reduction. Ideal for blog posts, social media, and product photos.</p>
          </div>
          <div className="rounded-xl border border-border p-4 space-y-1">
            <h3 className="font-semibold text-text-main text-sm">PNG</h3>
            <p className="text-xs text-text-muted leading-relaxed">Best for images with transparency, logos, and graphics with flat colors. Supports lossless compression. Use PNG when you need sharp edges and alpha transparency.</p>
          </div>
          <div className="rounded-xl border border-border p-4 space-y-1">
            <h3 className="font-semibold text-text-main text-sm">WebP</h3>
            <p className="text-xs text-text-muted leading-relaxed">Modern format from Google that outperforms both JPG and PNG. Supported by all modern browsers. WebP delivers 25–35% smaller files than JPG at equivalent quality.</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <h2 className="text-xl font-bold text-text-main">How to Reduce Image Size to a Specific KB</h2>
        <p className="text-text-muted text-sm leading-relaxed">
        ...
        <p className="text-text-muted text-sm leading-relaxed">
          As a general rule: <strong className="text-text-main">Quality 80</strong> = roughly 60–75% reduction from original. <strong className="text-text-main">Quality 60</strong> = roughly 75–85% reduction. <strong className="text-text-main">Quality 40</strong> = 85–90% reduction (noticeable quality loss on large prints). For web use, quality 70–85 is the optimal range for most images.
        </p>
      </div>

      <div className="space-y-3">
        <h2 className="text-xl font-bold text-text-main">Privacy — Your Images Never Leave Your Device</h2>
        <p className="text-text-muted text-sm leading-relaxed">
        ...
        <p className="text-text-muted text-sm leading-relaxed">
          For full details on how we handle data and advertising,
          see our{' '}
