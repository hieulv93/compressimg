      ...
      <div className="max-w-3xl mx-auto px-4 py-10 sm:py-14">
        ...
        <div className="space-y-8 text-sm text-text-muted leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              By accessing or using CompressImg.pro (&quot;the Service&quot;), you agree to be bound by these Terms of Service.
          ...
          <section className="space-y-2">
            ...
            <p>
              CompressImg.pro provides a free, browser-based image compression tool that allows users to reduce the file
              size of JPG, PNG, and WebP images. All processing occurs locally in your web browser — no images are uploaded
              to any server.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              You retain full ownership of all images you compress using this Service. We make no claim to any content
              you process through CompressImg.pro. The Service software, design, and code are owned by CompressImg.pro
          ...
          <section className="space-y-2">
            ...
            <p>
              The Service is provided &quot;as is&quot; without warranties of any kind. Because all compression occurs in your browser,
              the quality and performance of results may vary depending on your device, browser version, and image content.
              We do not guarantee specific compression ratios or output quality.
            </p>
            <p>
              We are not responsible for any loss of image quality, data loss, or other issues arising from use of the Service.
              Always keep a backup of your original images before compressing.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              To the maximum extent permitted by law, CompressImg.pro shall not be liable for any indirect, incidental,
              special, consequential, or punitive damages, including loss of data, arising from your use of or inability
              to use the Service.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              The Service is free and supported by advertising through Google AdSense. Ads are displayed after you receive
              value from the Service (after compression is complete). We comply with Google AdSense program policies.
            </p>
          </section>
