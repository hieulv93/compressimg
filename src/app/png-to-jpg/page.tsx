...
import PngToJpgContentSection from '@/components/tool/PngToJpgContentSection'
    ...
    <main className="flex-1">
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-2xl sm:text-3xl font-bold text-text-main">PNG to JPG Converter</h1>
