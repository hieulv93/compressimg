...
import ImageConverterContentSection from '@/components/tool/ImageConverterContentSection'
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Convert images between JPG, PNG, and WebP instantly — free, private, 100% in your
            browser
          </p>
        </div>
