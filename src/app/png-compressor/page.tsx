...
import PngCompressorContentSection from '@/components/tool/PngCompressorContentSection'
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Reduce PNG file size instantly — transparency preserved, 100% browser-based, no sign-up
          </p>
        </div>
