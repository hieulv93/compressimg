...
import CompressJpegContentSection from '@/components/tool/CompressJpegContentSection'
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Compress JPG and JPEG file size by up to 90% — no uploads, 100% browser-based
          </p>
        </div>
