...
import CompressForShopifyContentSection from '@/components/tool/CompressForShopifyContentSection'

type PageState = 'idle' | 'processing' | 'done' | 'error'

export default function CompressForShopifyPage() {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-2xl sm:text-3xl font-bold text-text-main">
            Compress Images for Shopify — Free, No Upload
          </h1>
          <p className="text-text-muted text-sm sm:text-base">
            Reduce product photo file size to under 500KB for faster Shopify store loading — 100%
        ...
        <CompressForShopifyContentSection />
      </div>
    </main>
  )
}
