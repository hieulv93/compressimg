...
import CompressForDiscordContentSection from '@/components/tool/CompressForDiscordContentSection'
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Stay under the 10MB Discord upload limit — compress JPG, PNG, and screenshots fast
          </p>
        </div>
        ...
        <CompressForDiscordContentSection />
      </div>
    </main>
  )
}
