...
import CompressForLinkedInContentSection from '@/components/tool/CompressForLinkedInContentSection'

type PageState = 'idle' | 'processing' | 'done' | 'error'

export default function CompressForLinkedInPage() {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Reduce photo size before uploading to LinkedIn — keep profile photos and post images
            sharp
          </p>
        </div>
        ...
        <CompressForLinkedInContentSection />
      </div>
    </main>
  )
}
