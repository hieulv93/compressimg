      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Automatically reduce any image to under 50KB — passport portal (DS-160), NEET, JEE, and
            government exam applications. JPEG output, 100% browser-based and private.
          </p>
        </div>

        <ResizeToKbTool defaultTargetKb={50} />

        <ResizeToKbSubPageSection targetKb={50} />
      </div>
    </main>
  )
}
