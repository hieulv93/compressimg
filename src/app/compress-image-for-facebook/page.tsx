...
import CompressForFacebookContentSection from '@/components/tool/CompressForFacebookContentSection'

type PageState = 'idle' | 'processing' | 'done' | 'error'

export default function CompressForFacebookPage() {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Reduce photo size before posting on Facebook — avoid quality loss from
            double-compression
          </p>
        </div>
        ...
        <CompressForFacebookContentSection />
      </div>
    </main>
  )
}
