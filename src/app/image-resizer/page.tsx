...
import ImageResizerContentSection from '@/components/tool/ImageResizerContentSection'
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Resize images to any pixel dimensions instantly — free, private, 100% in your browser
          </p>
        </div>
