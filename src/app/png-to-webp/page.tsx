...
import PngToWebpContentSection from '@/components/tool/PngToWebpContentSection'
    ...
    <main className="flex-1">
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-2xl sm:text-3xl font-bold text-text-main">PNG to WebP Converter</h1>
          <p className="text-text-muted text-sm sm:text-base">
            Convert PNG to WebP instantly — 26–80% smaller, preserves transparency, free, 100% in
            your browser
          </p>
        </div>
