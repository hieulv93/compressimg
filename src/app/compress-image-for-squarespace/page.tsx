...
import CompressForSquarespaceContentSection from '@/components/tool/CompressForSquarespaceContentSection'

type PageState = 'idle' | 'processing' | 'done' | 'error'

export default function CompressForSquarespacePage() {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Reduce image file size to under 500KB for faster Squarespace page loading — 100%
        ...
        <CompressForSquarespaceContentSection />
      </div>
    </main>
  )
}
