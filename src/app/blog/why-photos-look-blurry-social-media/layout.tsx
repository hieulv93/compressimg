...
const PAGE_URL = pageUrl('/blog/why-photos-look-blurry-social-media')
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Why Photos Look Blurry on Social Media',
      },
    ],
    locale: 'en_US',
    type: 'article',
...
const schema = schemaScript({
  ...
  trail: [
    ...
    { name: 'Why Photos Look Blurry on Social Media', url: PAGE_URL },
  ],
  props: {
    url: PAGE_URL,
    name: 'Why Do Exported Images Look Blurry on Social Media? (2026 Fix)',
    blog: {
    ...
    faq: [
      {
        question: 'Will pre-compressing really make a visible difference?',
        answer:
      ...
      {
        question: 'Does this work on iPhone photos (HEIC)?',
        answer:
          'iPhone photos saved in HEIC format need to be converted to JPG before most social platforms accept them. Use the HEIC to JPG converter, then compress at quality 80 before uploading. Alternatively, you can set your iPhone camera to shoot in "Most Compatible" mode (JPG) under Settings → Camera → Formats.',
      },
      {
        question: 'Why does my photo look fine on my phone but blurry on the platform?',
        answer:
      ...
      {
        question: 'Does image format matter (JPG vs PNG vs WebP)?',
        answer:
          'Yes. For social media, JPG is the safest format. Platforms are optimized for JPG input and handle it predictably. PNG uploads are converted to JPG internally by most platforms, adding an extra encoding step. WebP is not accepted by Instagram and TikTok. For photos: use JPG.',
      },
      {
        question: 'What resolution should I upload for the best quality?',
        answer:
