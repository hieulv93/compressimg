...
const PAGE_URL = pageUrl('/blog/what-is-base64-encoding')
...
const schema = schemaScript({
  ...
  trail: [
    ...
    { name: 'What Is Base64 Encoding?', url: PAGE_URL },
  ],
  props: {
    url: PAGE_URL,
    name: 'What Is Base64 Encoding? A Plain-English Explanation',
    blog: {
    ...
    faq: [
      {
        question: 'Why does Base64 make image files 33% larger?',
        answer:
      ...
      {
        question: 'Can I use a Base64 image in an img tag?',
        answer:
      ...
      {
        question: 'Does Base64 compress images?',
        answer:
      ...
      {
        question: 'Are Base64 images cached by the browser?',
        answer:
      ...
      {
        question: 'What is the difference between Base64 and a regular image URL?',
        answer:
