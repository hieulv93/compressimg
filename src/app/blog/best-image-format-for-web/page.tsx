            ...
            <div className="space-y-5">
              {[
                ...
                },
                {
                  ...
                  a: 'AVIF produces 20–30% smaller files than WebP but has incomplete browser support (especially on iOS). For 2026, use WebP for maximum compatibility. If your audience is primarily on modern Chrome or Firefox, AVIF is worth testing with a picture element fallback.',
                },
                {
