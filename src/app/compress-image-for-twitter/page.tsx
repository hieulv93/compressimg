...
import CompressForTwitterContentSection from '@/components/tool/CompressForTwitterContentSection'
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Reduce photo size before tweeting — avoid quality loss from Twitter&apos;s
            re-compression
          </p>
        </div>
        ...
        <CompressForTwitterContentSection />
      </div>
    </main>
  )
}
