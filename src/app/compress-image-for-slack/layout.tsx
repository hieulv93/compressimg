...
export const metadata: Metadata = {
  title: 'Fix Blurry Images on Slack — Compress Before Uploading (Free, No Sign-Up)',
  description:
    'Slack re-compresses image previews in channels and DMs. Pre-compress to quality 80 before uploading to keep photos sharp for all teammates — free, browser-based, no sign-up.',
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'Fix Blurry Images on Slack — Compress Before Uploading (Free, No Sign-Up)',
    description:
      'Slack re-compresses image previews in channels and DMs. Pre-compress to quality 80 before uploading to keep photos sharp for all teammates — free, browser-based.',
    url: PAGE_URL,
