...
const PAGE_URL = pageUrl('/compress-image-to-30kb')
...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Compress Image to 30KB Online',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Compress Image to 30KB Online Free — Any Format',
    description: 'Reduce any image to under 30KB for free. 100% browser-based — no uploads.',
...
const schema = schemaScript({
  ...
  trail: [
    ...
    { name: 'Compress Image to 30KB Online Free', url: PAGE_URL },
  ],
  props: {
    url: PAGE_URL,
