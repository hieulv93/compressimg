...
import CompressForYouTubeContentSection from '@/components/tool/CompressForYouTubeContentSection'

type PageState = 'idle' | 'processing' | 'done' | 'error'

export default function CompressForYouTubePage() {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Reduce thumbnail and banner file size before uploading — stay under the 2MB limit, keep
            images sharp
          </p>
        </div>
        ...
        <CompressForYouTubeContentSection />
      </div>
    </main>
  )
}
