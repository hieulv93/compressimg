...
import CompressForWixContentSection from '@/components/tool/CompressForWixContentSection'

type PageState = 'idle' | 'processing' | 'done' | 'error'

export default function CompressForWixPage() {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-2xl sm:text-3xl font-bold text-text-main">
            Compress Images for Wix — Free, No Upload
          </h1>
          <p className="text-text-muted text-sm sm:text-base">
            Reduce image file size to under 500KB for faster Wix website loading — 100%
