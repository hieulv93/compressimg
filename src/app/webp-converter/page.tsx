...
import WebpConverterContentSection from '@/components/tool/WebpConverterContentSection'
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Convert JPG, PNG to WebP — or WebP back to JPG, PNG — free, no upload to server
          </p>
        </div>
