...
import CompressForResumeContentSection from '@/components/tool/CompressForResumeContentSection'

type PageState = 'idle' | 'processing' | 'done' | 'error'

export default function CompressForResumePage() {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-2xl sm:text-3xl font-bold text-text-main">
            Compress Image for Resume &amp; CV — Free, No Upload
          </h1>
          <p className="text-text-muted text-sm sm:text-base">
            Reduce your CV photo to under 100KB in seconds — fits Naukri, LinkedIn, Indeed, and all
            job portal limits. Your photo never leaves your device.
          </p>
        </div>
        ...
        <CompressForResumeContentSection />
      </div>
    </main>
  )
}
