...
import CompressForPassportContentSection from '@/components/tool/CompressForPassportContentSection'

type PageState = 'idle' | 'processing' | 'done' | 'error'

export default function CompressForPassportPage() {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-2xl sm:text-3xl font-bold text-text-main">
            US Passport Photo Compressor — Free, No Upload
          </h1>
          <p className="text-text-muted text-sm sm:text-base">
            Compress passport photos under 240KB for US passport applications — JPEG output, 100%
        ...
        <CompressForPassportContentSection />
      </div>
    </main>
  )
}
