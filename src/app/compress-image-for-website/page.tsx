...
import CompressForWebsiteContentSection from '@/components/tool/CompressForWebsiteContentSection'

type PageState = 'idle' | 'processing' | 'done' | 'error'

export default function CompressForWebsitePage() {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-text-muted text-sm sm:text-base">
            Reduce image file size for faster page loading, better Core Web Vitals, and higher
            Google rankings — 100% browser-based, your images never leave your device.
          </p>
        </div>
        ...
        <CompressForWebsiteContentSection />
      </div>
    </main>
  )
}
